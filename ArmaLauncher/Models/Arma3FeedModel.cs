...
{
    public class Arma3FeedModel
    {
        [Serializable]
        public class Servers
        {
            private List<ServersScript> _scriptField;

            private List<ServersServer> _serverField;

            private string _typeField;


            [XmlElement("script", Form = XmlSchemaForm.Unqualified)]
            public List<ServersScript> Script
            {
                get { return _scriptField; }
                set { _scriptField = value; }
            }


            [XmlElement("server", Form = XmlSchemaForm.Unqualified)]
            public List<ServersServer> Server
            {
                get { return _serverField; }
        ...
        public class ServersServer
        {
            ...
            [XmlElement("battleye", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("created-at", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("dedicated", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("id", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("language", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("lat", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("lng", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("mode", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("modhash", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("passworded", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("players", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("port", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("required-version", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("signatures", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("updated-at", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
            ...
            [XmlElement("verify-signatures", Form = XmlSchemaForm.Unqualified, IsNullable = true)]
