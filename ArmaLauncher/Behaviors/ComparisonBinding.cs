...
{
    /*  XAML USAGE: 
            <TextBlock x:Name="tbMaxPingValue" Foreground="GreenYellow"">
                <TextBlock.Style>
                    <Style>
                        <Style.Triggers>
                            <DataTrigger Binding="{Behaviors:ComparisonBinding MaxPing, GT, 0}" Value="{x:Null}">
                                <Setter Property="TextBlock.Text" Value="{Binding MaxPing}"/>
                            </DataTrigger>
                            <DataTrigger Binding="{Behaviors:ComparisonBinding MaxPing, EQ, 0}" Value="{x:Null}">
